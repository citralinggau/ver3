...
sleep 2
clear
wget https://raw.githubusercontent.com/citralinggau/ver3/main/ssh/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
### Pasang Rclone
...
wget https://raw.githubusercontent.com/citralinggau/ver3/main/sshws/insshws.sh && chmod +x insshws.sh && ./insshws.sh
clear
cat> /root/.profile << END
# ~/.profile: executed by Bourne-compatible login shells.
...
echo " "
echo "=====================-[ SCRIPT WokszXD Tzy TUNNEL ]-===================="
echo ""
echo "------------------------------------------------------------"
echo ""
echo ""
...
echo "------------------------------------------------------------"
echo ""
echo "===============-[ Script Created By WokszXD Tzy ]-==============="
echo -e ""
echo ""
echo "" | tee -a log-install.txt
rm /root/setup.sh >/dev/null 2>&1
